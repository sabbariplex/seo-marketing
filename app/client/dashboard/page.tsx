    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-1">
          {data.clientName ? `${data.clientName} - ` : ''}Overview of your SEO and marketing performance
        </p>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <MetricChart
          ...
          xAxisKey="date"
          description="Your organic traffic trends over the last 30 days"
        />
        <MetricChart
          title="Conversions"
          ...
          dataKey="conversions"
          xAxisKey="date"
          description="Your conversion tracking over time"
        />
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <MetricChart
          ...
          dataKey="sessions"
          xAxisKey="source"
          description="Breakdown of your traffic by source"
        />
        <MetricChart
          ...
          dataKey="count"
          xAxisKey="date"
          description="Your backlink growth over time"
        />
      </div>
      ...
      <div className="grid gap-4">
        <div className="rounded-lg border bg-card p-6">
          <h3 className="text-lg font-semibold mb-4">Your Top Keyword Rankings</h3>
